...
// var nums2 = [1,2,34,54,55,34,32,11,19,17,54,66,13];
var evens = [];
var odds = [];
//Write a function called divider that is given three arguments, nums, evens, and odds.
//Have divider return an Array with the first item in the array being the evens array (all the even values from nums) and the second item in the Array being the odds array(all the odd values from nums).
// var oddsFinder = function(array) {
//   // var nums = [1,2,34,54,55,34,32,11,19,17,54,66,13];
...
// var evensFinder = function(array) {
//   for (var i = 0; i < array.length; i++) {
//     if (array[i] % 2 === 1) { 
//       array.splice(i, 1);
//       i--;
...
// var divider = function(array1, array2) {
...
var divider = function (nums, evens, odds) {
  ...
  for (var i = 0; i < nums.length; i++) {
    ...
    // If it is even push the value to evens array
    // If odd ""
  }
  arr.push(evens); 
  arr.push(odds);
...
var addItem = function(newItem, myList) {
  var myNewList = [];
...
var longerNumber = function(arrayOne, arrayTwo) {
